 ...
 * 
 * A password database seems to be a little corrupted.
 ...
 * password to be valid. For example [1-3 a: abcde]: 1-3 a means that the password must
...
let arrEntries = entries.split('\n');

// Split each array item into three and make subarrays ready for testing
arrEntries = arrEntries.map(array => {
    array = array.split(' ');
...
// Initialize correct password counter
let correctPasword = 0;
